...
document.getElementById("btnRegistro").addEventListener("click", async () => {
    ...
    if (response.ok) {
        ...
        // Opcional: limpiar los campos del formulario de registro
        document.getElementById("txtRegistroUsuario").value = "";
        document.getElementById("txtRegistroPassword").value = "";
    }
